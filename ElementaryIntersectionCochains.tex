...
\begin{figure}[H]
	\begin{center}
		...
		\end{pspicture}
	\end{center}
\caption{Example in the case $n=1$ with $\sigma^{-1}(W)$ in orange, points in $\left(\left.\sigma\right|_{\partial\Delta^2}\right)^{-1}(V)$ marked in red, and those in $\sigma^{-1}(\partial V)$ marked in blue.}
\end{figure}
